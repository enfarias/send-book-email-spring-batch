package com.treinamento.sendMailLoanBook.processor;
...
import com.treinamento.sendMailLoanBook.util.GenerateBookReturnDate;
	...
	ItemProcessor<UserBookLoan, Mail> processLoanNotificationEmailProcessor() {
		return new ItemProcessor<UserBookLoan, Mail>() {
			...
			public Mail process(UserBookLoan loan) throws Exception {				
				Email from = new Email("edson.ney@gmail.com", "Biblioteca Municipal");
